...
>(({ className, sideOffset = 4, ...props }, ref) => (
  <DropdownMenuPrimitive.Portal>
    <DropdownMenuPrimitive.Content
      ...
      className={cn(
        "select-none z-50 min-w-[8rem] overflow-hidden rounded-3xl border bg-popover p-1 text-popover-foreground shadow-md",
...
>(({ className, inset, ...props }, ref) => (
  <DropdownMenuPrimitive.Item
    ref={ref}
    className={cn(
      "relative text-muted-foreground flex select-none items-center rounded-sm px-2 py-1.5 text-sm outline-none transition-colors focus:bg-primary/30 focus:text-primary data-[disabled]:pointer-events-none data-[disabled]:opacity-50 font-poppins font-semibold md:font-medium cursor-pointer",
      inset && "pl-8",
      className
    )}
    {...props}
...
>(({ className, inset, ...props }, ref) => (
  <DropdownMenuPrimitive.Label
    ref={ref}
    className={cn(
      "px-2 py-1.5 text-sm font-poppins text-muted-foreground font-bold md:font-semibold",
      inset && "pl-8",
      className
    )}
    {...props}
