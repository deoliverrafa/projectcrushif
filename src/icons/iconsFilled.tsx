export const HomeFilledIcon = (props: React.SVGAttributes<SVGSVGElement>) => {
  return (
    <svg
...
export const CalendarFilledIcon = (props: React.SVGAttributes<SVGSVGElement>) => {
  return (
    <svg
      viewBox="0 0 24 24"
      fill="currentColor"
...
export const HeartArrowFilledIcon = (props: React.SVGAttributes<SVGSVGElement>) => {
  return (
    <svg
      fill="currentColor"
      viewBox="0 0 16 16"
...
export const BellFilledIcon = (props: React.SVGAttributes<SVGSVGElement>) => {
  return (
    <svg
      viewBox="0 0 1024 1024"
      fill="currentColor"
...
export const MoonFilledIcon = (props: React.SVGAttributes<SVGSVGElement>) => {
  return (
    <svg
      viewBox="0 0 24 24"
      fill="currentColor"
...
export const SunFilledIcon = (props: React.SVGAttributes<SVGSVGElement>) => {
  return (
    <svg
      viewBox="0 0 24 24"
      fill="currentColor"
