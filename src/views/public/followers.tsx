...
const FollowersLayout = () => {
  ...
  const [followersUsers,
    setFollowersUsers] = React.useState < User[] > ([]);
  const [filteredUsers,
    setFilteredUsers] = React.useState < User[] > ([]);
  const [searchQuery,
    setSearchQuery] = React.useState < string > ("");
          ...
          <DrawerContent>
            <div className="mx-auto w-full max-w-sm">
              ...
              <DrawerDescription className="text-foreground">
                {filteredUsers.length} usuários seguindo
                esté perfil no Crush IF.
              </DrawerDescription>
            </div>

            <DrawerFooter>
              <DrawerDescription className="text-xs md:text-xs text-center">
                Você está vendo os usuários seguindo esté
                perfil no Crush IF.
              </DrawerDescription>
            </DrawerFooter>
          </div>
